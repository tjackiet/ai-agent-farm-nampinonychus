...
- **予算は緩やかにしか増やさない**（110k→210k、2倍未満）。倍々に張るマーチンゲールは採りません。
- **合計は初期資金の 80%**。残り 20% は使いません（`risk-policy.md`）。
...
| 段  | 指値価格  | 予算    | 数量   |
| --- | --------- | ------- | ------ |
| 1   | 9,950,000 | 110,000 | 0.0110 |
| 2   | 9,900,250 | 135,000 | 0.0136 |
| 3   | 9,830,948 | 160,000 | 0.0162 |
| 4   | 9,732,638 | 185,000 | 0.0190 |
| 5   | 9,586,648 | 210,000 | 0.0219 |

5段すべて約定した場合：取得原価 約 798,222 JPY / 0.0817 BTC、
**平均取得単価 約 9,770,165 JPY**（アンカーから -2.30%）。
